...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@miniproject-yogaconnect.6l7t2.mongodb.net/?retryWrites=true&w=majority&appName=miniproject-yogaconnect`;
...
async function run() {
    try {
        ...
        const database = client.db("miniproject-yogaconnect");
