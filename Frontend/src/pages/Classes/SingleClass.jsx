...
const SingleClass = () => {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="breadcrumbs bg-secondary py-10 mt-20 section-padding bg-cover bg-center bg-no-repeat dark:bg-secondary dark:text-white">
  ...
  width="100%"
  height="100%"
  src={`https://www.youtube.com/embed/${course.videoLink.split('youtu.be/')[1].split('?')[0]}?start=0&end=10&autoplay=1&rel=0`}
  title={course.name}
  frameBorder="0"
...
></iframe>
                  ...
                  <div className="wdiget">
                    <h4 className=" widget-title mb-4">Related Courses:</h4>
                    {
